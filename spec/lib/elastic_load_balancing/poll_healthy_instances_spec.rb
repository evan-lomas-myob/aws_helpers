...
describe 'AwsHelpers::ElasticLoadBalancing::PollHealthyInstances' do
  ...
  it '#poll_healthy_instances' do
    ...
    AwsHelpers::ElasticLoadBalancing::Client.new(options).poll_healthy_instances(load_balancer_name: load_balancer_name, required_instances: required_instances, timeout: timeout)
