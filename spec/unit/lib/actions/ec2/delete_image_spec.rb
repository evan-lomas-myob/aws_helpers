...
describe AwsHelpers::Actions::EC2::DeleteImage do
  ...
  describe '#execute' do
    ...
    let(:delete_snapshots) { instance_double(AwsHelpers::Actions::EC2::DeleteSnapshots) }
    ...
    before(:each) do
      ...
      allow(AwsHelpers::Actions::EC2::DeleteSnapshots).to receive(:new).and_return(delete_snapshots)
    ...
    it 'should call Aws::EC2::Client #describe_images with correct parameters' do
      ...
      AwsHelpers::Actions::EC2::DeleteImage.new(config, image_id, stdout: stdout).execute
    end
    ...
    it 'should call AwsHelpers::Actions::EC2::DeleteSnapshots #new with correct parameters' do
      expect(AwsHelpers::Actions::EC2::DeleteSnapshots).to receive(:new).with(config, ['snapshot_id'], stdout: stdout)
      AwsHelpers::Actions::EC2::DeleteImage.new(config, image_id, stdout: stdout).execute
    end
