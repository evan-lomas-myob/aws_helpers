...
describe AwsHelpers::Actions::EC2::ImageDelete do
  describe '#execute' do
    ...
    it 'should call AwsHelpers::Actions::EC2::PollImageDeleted #new with correct parameters' do
      expect(AwsHelpers::Actions::EC2::PollImageDeleted).to receive(:new).with(config, image_id, stdout: stdout, delay: delay, max_attempts: max_attempts)
      AwsHelpers::Actions::EC2::ImageDelete.new(config, image_id, stdout: stdout, delay: delay, max_attempts: max_attempts).execute
    end
