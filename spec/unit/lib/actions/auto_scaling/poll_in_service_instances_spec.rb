...
describe AwsHelpers::Actions::AutoScaling::PollInServiceInstances do
  ...
  describe '#execute' do
    ...
    it 'should call the Aws::AutoScaling::Client #describe_auto_scaling_instances with correct parameters' do
      ...
      AwsHelpers::Actions::AutoScaling::PollInServiceInstances.new(std_out, config, auto_scaling_group_name, 1, 0).execute
    end
    ...
    it 'should poll until all instances are in service' do
      ...
      AwsHelpers::Actions::AutoScaling::PollInServiceInstances.new(std_out, config, auto_scaling_group_name, 2, 0).execute
    end
    ...
    it 'should throw an error if expected number of servers is not reached by the retry period' do
      ...
      allow(auto_scaling_client).to receive(:describe_auto_scaling_groups).and_return(response)
      expect { AwsHelpers::Actions::AutoScaling::PollInServiceInstances.new(std_out, config, auto_scaling_group_name, 1, 0).execute }.to raise_error(Aws::Waiters::Errors::TooManyAttemptsError)
    end
